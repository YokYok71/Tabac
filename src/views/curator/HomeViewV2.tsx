  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh", background: C.bg, fontFamily: F.body, color: C.tx }}>
      ...
      <div style={{ paddingBottom: 130 }}>
        ...
        <div style={{ paddingTop: "max(env(safe-area-inset-top, 0px), 14px)", paddingLeft: 18, paddingRight: 14, paddingBottom: 8, display: "flex", justifyContent: "space-between", alignItems: "center", position: "sticky", top: 0, zIndex: 20, background: C.bg, transform: "var(--chrome-shift, none)", transition: "transform var(--chrome-ms, 220ms) cubic-bezier(0.22, 1, 0.36, 1)" }}>
