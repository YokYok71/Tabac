...
var CSV_COLUMNS: Record<string, Record<string, string>> = {
  ...
  agingMax: { fr: "Age max cave (ans)", en: "Aging max", es: "Envejecimiento", de: "Reifung", it: "Invecchiamento", pt: "Envelhecimento" },
  status: { fr: "Statut", en: "Status", es: "Estado", de: "Status", it: "Stato", pt: "Estado" },
  disposed: { fr: "Éliminé", en: "Disposed", es: "Eliminado", de: "Entsorgt", it: "Eliminato", pt: "Eliminado" },
  ...
  dateProduction: { fr: "Date production", en: "Production date", es: "Fecha producción", de: "Herstellungsdatum", it: "Data produzione", pt: "Data produção" },
  ...
  duration: { fr: "Durée (min)", en: "Duration (min)", es: "Duración (min)", de: "Dauer (Min.)", it: "Durata (min)", pt: "Duração (min)" },
  smoked: { fr: "Quantité fumée", en: "Amount smoked", es: "Cantidad fumada", de: "Gerauchte Menge", it: "Quantità fumata", pt: "Quantidade fumada" },
  aromas: { fr: "Arômes", en: "Aromas", es: "Aromas", de: "Aromen", it: "Aromi", pt: "Aromas" },
